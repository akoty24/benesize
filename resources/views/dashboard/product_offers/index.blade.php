                ...
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tr>
                            ...
                            <th scope="col">@lang('translation.Discount_Type')</th>
                            <th scope="col">@lang('translation.Discount_Value')</th>
                        ...
                        @foreach ($productOffers as $productOffer)
                            <tr>
                                ...
                                <td>{{ $productOffer->discount_type }}</td>
                                <td>{{ $productOffer->discount_value }}</td>
                                ...
                                @endif
                                    ...
                                    <div class="row" style="margin: 0;">
                                        ...
                                        <div class="col" style="flex: 0 0 0%">
                                            <a href="{{ route('product_offers.edit', $productOffer->id) }}" class="btn btn-outline-success">@lang('translation.Edit')</a>
                                        </div>
                                        <!-- Delete Button -->
                                        <div class="col">
                                            <form action="{{ route('product_offers.destroy', $productOffer->id) }}" method="POST" style="display:inline">
                                                @csrf
                                                @method('DELETE')
