                ...
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tr>
                            ...
                            <th scope="col">@lang('translation.permissions')</th>
                            ...
                            <tr>
                                ...
                                <td>  <ul style="float: left">
                                            ...
                                            @foreach($role->permissions as $permission)
                                               <span class="badge rounded-pill bg-info float-end"> {{ $permission->name }}</span>
                                            @endforeach

                                    </ul></td>
                                <td>
                                    <a href="{{ route('roles.edit', $role->id) }}" class="btn btn-outline-success">@lang('translation.Edit')</a>
