...
@section('title')
    @lang('translation.Sub Categories List')
@endsection
...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
            @lang('translation.Sub Categories')
        @endslot
        @slot('title')
            @lang('translation.Sub Categories List')
        @endslot
                ...
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tr>
                            ...
                            <th scope="col">@lang('translation.Category ID')</th>
                                ...
                                <td>
                                    <div class="row" style="margin: 0 0 0 0;">
                                        ...
                                        <div class="col" style="flex: 0 0 0%">
                                            <a href="{{ route('sub_categories.edit', $subcategory->id) }}" class="btn btn-outline-success">@lang('translation.Edit')</a>
                                        </div>
                                        <!-- Delete Button -->
                                        <div class="col">
