                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        @foreach ($areas as $area)
                            <tr>
                                ...
                                @endif
                                <td>{{ $area->sort }}</td>
                                <td>{{ $area->city->general_title }}</td>
                                <td>
                                    <a href="{{ route('areas.edit', $area->id) }}" class="btn btn-primary">@lang('translation.Edit')</a>
