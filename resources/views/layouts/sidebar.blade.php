            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('categories.index')}}"
                               key="t-light-sidebar">@lang('translation.category')</a></li>
                        <li><a href="{{route('categories.create')}}"
                               key="t-light-sidebar">@lang('translation.add')</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-folder-open"></i>
                        <span key="t-dashboards">@lang('translation.s_categories')</span>
                    </a>

                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('sub_categories.index')}}"
                               key="t-light-sidebar">@lang('translation.S_Categories')</a></li>
                        <li><a href="{{route('sub_categories.create')}}"
                               key="t-light-sidebar">@lang('translation.add')</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-dashboards">@lang('translation.Products')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('products.index')}}"
                               key="t-light-sidebar">@lang('translation.products')</a></li>
                        <li><a href="{{route('products.create')}}"
                               key="t-light-sidebar">@lang('translation.add')</a></li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                               key="t-vertical">@lang('translation.Color')</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{route('product_colors.index')}}"
                                       key="t-light-sidebar">@lang('translation.product_colors')</a></li>
                                <li><a href="{{route('product_colors.create')}}"
                                       key="t-light-sidebar">@lang('translation.add')</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                               key="t-vertical">@lang('translation.Size')</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{route('products.index')}}"
                                       key="t-light-sidebar">@lang('translation.product_sizes')</a></li>
                                <li><a href="{{route('products.create')}}"
                                       key="t-light-sidebar">@lang('translation.add')</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                               key="t-vertical">@lang('translation.Offers')</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{route('product_offers.index')}}"
                                       key="t-light-sidebar">@lang('translation.product_offers')</a></li>
                                <li><a href="{{route('product_offers.create')}}"
                                       key="t-light-sidebar">@lang('translation.add')</a></li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-dashboards">@lang('translation.Sizes')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('sizes.index')}}"
                               key="t-light-sidebar">@lang('translation.sizes')</a></li>
                        <li><a href="{{route('sizes.create')}}"
                               key="t-light-sidebar">@lang('translation.add')</a></li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-dashboards">@lang('translation.Colors')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('colors.index')}}"
                               key="t-light-sidebar">@lang('translation.colors')</a></li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-dashboards">@lang('translation.Coupons')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('coupons.index')}}"
                               key="t-light-sidebar">@lang('translation.Coupons')</a></li>
                        <li><a href="{{route('coupons.create')}}"
                               key="t-light-sidebar">@lang('translation.add')</a></li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                               key="t-vertical">@lang('translation.Coupon_User')</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{route('coupon_users.index')}}"
                                       key="t-light-sidebar">@lang('translation.Coupon_User')</a></li>
                                <li><a href="{{route('coupon_users.create')}}"
                                       key="t-light-sidebar">@lang('translation.add')</a></li>
                            </ul>
                        </li>
                    </ul>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    <li class="menu-title" key="t-menu">@lang('translation.Places')</li>
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="bx bxs-flag"></i>
                            <span key="t-dashboards">@lang('translation.Countries')</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('countries.index')}}"
                                   key="t-light-sidebar">@lang('translation.Countries')</a></li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-dashboards">@lang('translation.Cities')</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('cities.index')}}"
                                   key="t-light-sidebar">@lang('translation.Cities')</a></li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-dashboards">@lang('translation.Areas')</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('areas.index')}}"
                                   key="t-light-sidebar">@lang('translation.Areas')</a></li>
                            <li><a href="{{route('areas.create')}}"
                                   key="t-light-sidebar">@lang('translation.add')</a></li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    <li class="menu-title" key="t-menu">@lang('translation.Users')</li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('users.index')}}"
                               key="t-light-sidebar">@lang('translation.Users')</a></li>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    <li class="menu-title" key="t-menu">@lang('translation.Role And permission')</li>

                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-key"></i>
                        <span key="t-dashboards">@lang('translation.Role And permission')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">

                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                               key="t-vertical">@lang('translation.roles')</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{route('roles.index')}}"
                                       key="t-light-sidebar">@lang('translation.roles')</a></li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow"
                               key="t-vertical">@lang('translation.permissions')</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{route('permissions.index')}}"
                                       key="t-light-sidebar">@lang('translation.permissions')</a></li>
